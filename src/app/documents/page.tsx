        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              ...
              <Card
                onClick={handleCreateDocument}
                className="group bg-gradient-to-br from-white/80 to-white rounded-sm border-2 border-dashed border-gray-200 hover:border-blue-400 transition-all duration-200 overflow-hidden aspect-[1/1.4142] relative flex flex-col items-center justify-center p-4 hover:shadow-md cursor-pointer"
              >
                <CardBody className="flex flex-col items-center justify-center">
                  ...
                  <CardTitle className="text-sm font-medium text-gray-900 group-hover:text-blue-600 transition-colors text-center">Create New Document</CardTitle>
              ...
              {documents.map((doc) => (
                ...
                >
                  ...
                  <CardBody className="p-4 h-full flex flex-col">
                    ...
                    <CardTitle className="text-sm font-semibold text-gray-900 mb-1 pr-12 line-clamp-2 group-hover:text-blue-600 transition-colors">
                      {doc.title}
                    </CardTitle>
                    ...
                    {/* Actions */}
                    <CardActions className="pt-2 mt-auto flex justify-end items-center border-t border-gray-100">
                      <button
                        onClick={(e) => {
                          e.preventDefault();
